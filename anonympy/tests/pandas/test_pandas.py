...
def test_get_numeric_columns(anonym_small, anonym_big):
...
def test_get_categorical_columns(anonym_small, anonym_big):
...
def test_get_datetime_columns(anonym_small, anonym_big):
...
# testing core.py - dfAnonymizer class and it's methods
